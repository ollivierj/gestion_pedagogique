...
public class AbsenceDaoImpl extends BaseDaoImpl<Absence, Integer> implements AbsenceDao{
	 ...
	 */
	public ArrayList<Absence> charger(int page, int pageSize, String orderColumn, String orderDirection, String searchText) throws Exception {
	 ...
	 */
	public Absence chargerDetail(Integer pId) throws Exception {
