...
public class SessionValidationDaoImpl extends BaseDaoImpl<SessionValidation, Integer> implements SessionValidationDao{
	 ...
	 */
	public ArrayList<SessionValidation> charger(int page, int pageSize, String orderColumn, String orderDirection, String searchText) throws Exception {
	 ...
	 */
	public SessionValidation chargerDetail(Integer pId) throws Exception {
