...
public class ProfilDaoImpl extends BaseDaoImpl<Profil, Integer> implements ProfilDao{
	 ...
	 */
	public ArrayList<Profil> charger(int page, int pageSize, String orderColumn, String orderDirection, String searchText) throws Exception {
	 ...
	 */
	public Profil chargerDetail(Integer pId) throws Exception {
