...
public class ModuleConfiguration extends AbstractModule {
    ...
    protected void configure() {
    	...
    	bind(StagiaireAvisDao.class).to(StagiaireAvisDaoImpl.class).in(Scopes.SINGLETON);
    	...
    	bind(StagiaireAvisService.class).to(StagiaireAvisServiceImpl.class).in(Scopes.SINGLETON);
