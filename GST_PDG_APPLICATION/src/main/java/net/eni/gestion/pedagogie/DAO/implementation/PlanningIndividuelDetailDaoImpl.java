...
public class PlanningIndividuelDetailDaoImpl extends BaseDaoImpl<PlanningIndividuelDetail, String> implements PlanningIndividuelDetailDao{
	 ...
	 */
	public ArrayList<PlanningIndividuelDetail> charger(PlanningIndividuelDetail pPlanningIndividuelDetail) throws Exception {
		return CRUDHelper.charger(this, pPlanningIndividuelDetail);
	}
	 ...
	 */
	public PlanningIndividuelDetail chargerDetail(PlanningIndividuelDetail pPlanningIndividuelDetail) throws Exception {
		return CRUDHelper.chargerDetail(this, pPlanningIndividuelDetail);
	}
	 ...
	 */
	public PlanningIndividuelDetail supprimer(PlanningIndividuelDetail pPlanningIndividuelDetail) throws Exception {
		return CRUDHelper.supprimer(this, pPlanningIndividuelDetail);
	}
