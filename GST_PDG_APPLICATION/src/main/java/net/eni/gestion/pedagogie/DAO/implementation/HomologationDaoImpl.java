...
public class HomologationDaoImpl extends BaseDaoImpl<Homologation, Integer> implements HomologationDao{
	 ...
	 */
	public ArrayList<Homologation> charger(int page, int pageSize, String orderColumn, String orderDirection, String searchText) throws Exception {
	 ...
	 */
	public Homologation chargerDetail(Integer pId) throws Exception {
