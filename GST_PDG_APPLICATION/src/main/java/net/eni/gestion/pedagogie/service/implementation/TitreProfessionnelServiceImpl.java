...
/**
 * @author jollivier
 * Classe d'implémentation pour le module de suivi des titreProfessionnels
 */
@Singleton
public class TitreProfessionnelServiceImpl extends AServiceImpl<TitreProfessionnel, Integer, TitreProfessionnelDao> implements TitreProfessionnelService {
