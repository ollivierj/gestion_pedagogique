...
public class FonctionDaoImpl extends BaseDaoImpl<Fonction, String> implements FonctionDao{
	 ...
	 */
	public ArrayList<Fonction> charger(Fonction pFonction) throws Exception {
		return CRUDHelper.charger(this, pFonction);
	}
	
	/* (non-Javadoc)
	 * @see net.eni.gestion.pedagogie.DAO.base.generique.CRUDBase#chargerDetail(net.eni.gestion.pedagogie.modele.Fonction)
	 */
	public Fonction chargerDetail(Fonction pFonction) throws Exception {
		return CRUDHelper.chargerDetail(this, pFonction);
	}
	 ...
	 */
	public Fonction supprimer(Fonction pFonction) throws Exception {
		return CRUDHelper.supprimer(this, pFonction);
	}
