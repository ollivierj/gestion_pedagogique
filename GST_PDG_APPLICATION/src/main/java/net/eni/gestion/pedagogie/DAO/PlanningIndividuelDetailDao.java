 ...
 * pour la gestion des détails d'un planning individuel de formation
 */
public interface PlanningIndividuelDetailDao extends CRUDDao<PlanningIndividuelDetail, String> {
