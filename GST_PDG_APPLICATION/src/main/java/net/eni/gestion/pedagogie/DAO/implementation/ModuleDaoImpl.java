...
public class ModuleDaoImpl extends BaseDaoImpl<Module, Integer> implements ModuleDao{
	 ...
	 */
	public ArrayList<Module> charger(int page, int pageSize, String orderColumn, String orderDirection, String searchText) throws Exception {
	 ...
	 */
	public Module chargerDetail(Integer pId) throws Exception {
