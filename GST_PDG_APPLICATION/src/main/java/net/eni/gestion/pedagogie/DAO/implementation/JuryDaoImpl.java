...
public class JuryDaoImpl extends BaseDaoImpl<Jury, Integer> implements JuryDao{
	 ...
	 */
	public ArrayList<Jury> charger(int page, int pageSize, String orderColumn, String orderDirection, String searchText) throws Exception {
	 ...
	 */
	public Jury chargerDetail(Integer pId) throws Exception {
