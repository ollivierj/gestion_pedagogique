 ...
 */
controllers.controller('detailFichierCtrl', function($scope, $modal, $filter, $modal, FileUploader, StagiaireFactory, FichiersFactory, fichiers, readonly, affFichiers, affTelech) {
